...
if isOnlyStatisticsName: 
	trainval = open("/opt/zhangjing/caffe/caffe/data/illbuild/benchmark_349/benchmark_349_.txt",'w+')
	#test = open("/opt/zhangjing/caffe/caffe/data/actions_new/benchmark_test1.txt",'w+')
	interval = 10
	orig_image_dir= "/opt/zhangjing/caffe/caffe/data/illbuild/benchmark_349/pictures/" #"/opt/zhangjing/caffe/data/actions_new/benchmark/pictures_1080_ratio_new_new_ratio_ratio/"
	...
	for i in xrange(len(files)): 
		...
		result = 'benchmark_349/pictures'+os.sep+file+' '+ 'benchmark_349/labels'+os.sep+basename+'.xml\n'
		lst.append(result)
