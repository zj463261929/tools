...
input_path = "/opt/zhangjing/caffe/caffe/data/actions_new/benchmark/labels/" #改
output_path = "/opt/zhangjing/caffe/caffe/data/actions_new/benchmark/labels_540/"	#改
...
ok_width = '<width>960</width>'				#改
ok_height = '<height>540</height>'				#改
