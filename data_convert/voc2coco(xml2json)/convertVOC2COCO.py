...
rootDir = '/home/ligang/data_convert/voc_coco-xml_json/xml'

#处理XML文件的索引的txt文件
#trainFile = "/opt/yushan/data/VOCdevkit/VOC2007/ImageSets/Main/val.txt"
trainFile = '/home/ligang/data_convert/voc_coco-xml_json/trainval.txt'

#输出json文件的路径
outjson = "voc_2007_trainval.json"
...
attrDict["categories"]=[
    {"supercategory":"none","id":1,"name":"handsup"},
    {"supercategory":"none","id":2,"name":"like"},
    {"supercategory":"none","id":3,"name":"hate"},
    {"supercategory":"none","id":4,"name":"sleep"}]
        ...
        for file in testXMLFiles:
            if file in files:
                ...
                if 'object' in doc['annotation']:                    
                    img_id_temp = str(doc['annotation']['filename']).split('.jpg')[0]
